...
@section('headsection')
<link rel="canonical" href="https://hcalculator.com/cc-to-hp-calculator2" />
@endsection
...
<div id="resultArea" class="mt-3 d-none">
    ...
    <div class="table-responsive d-none d-md-block">
        <table class="table border rounded" style="background:#eefbf3; border-color:#21c285;">
    ...
    <div id="mobileResultView" class="d-block d-md-none">
        </div>
</div>
        </div>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const mobileView = document.getElementById('mobileResultView'); 
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row pt-2 border-top" style="border-color: rgba(0,0,0,0.05) !important;">
                            ...
                            <div class="col-6 text-end">
                                ...
                                <span class="fw-bold small">${eng.factor} cc/HP</span>
                            </div>
                        </div>
                    </div>
                </div>`;
